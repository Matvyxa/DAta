...
-- Домашнее заданиe: Составьте список пользователей users, которые осуществили хотя бы один заказ (orders) в интернет-магазине.
-- добавляем изменения в заказы
ALTER TABLE
	orders 
CHANGE COLUMN
	user_id user_id BIGINT(20) UNSIGNED NOT NULL;
 -- добавляем внешний ключи       
ALTER TABLE orders
